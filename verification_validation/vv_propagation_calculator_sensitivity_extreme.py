...
from orbit_calculations import PropagationTime, Model
...
def extreme_large_a():
    propagation_time = PropagationTime(orbit_parameters=np.array([[20e20, 0, 0, 0, 0, 0], [20e20, 0, 0, 0, 180, 0]]),
                                       final_time=86400 * 1000)
    propagation_time.plot_kepler(0)
...
def extreme_large_i():
    propagation_time = PropagationTime(
        orbit_parameters=np.array([[20e6, 0, 1000, 0, 0, 0], [20e6, 0, 1000, 0, 180, 0]]))
    propagation_time.plot_kepler(1)
    propagation_time.plot_time()
...
def extreme_large_e():
    propagation_time = PropagationTime(
        orbit_parameters=np.array([[20e6, 1000000, 0, 0, 0, 0], [20e6, 100000, 0, 0, 180, 0]]))
    propagation_time.plot_kepler(1)
    propagation_time.plot_time()
...
def extreme_large_argument_of_periapsis():
    propagation_time = PropagationTime(
        orbit_parameters=np.array([[20e6, 0, 0, 10000, 0, 0], [20e6, 0, 0, 10000, 180, 0]]))
    propagation_time.plot_kepler(1)
    propagation_time.plot_time()
...
def sensitivity_mass():
    ...
    print(
        f"max_range :{change_range_max},avg range: {change_range_avg}, sd_range:{change_range_sd}, detla_v change:{change_delta_v}")
