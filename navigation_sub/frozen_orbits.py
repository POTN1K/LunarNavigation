...
# constellation_8orbits_4 = constellation_8orbits.copy()
# constellation_8orbits_5= constellation_8orbits.copy()
constellation_8orbits_2[:, 5] += 45
constellation_8orbits_3[:, 5] += 135
# constellation_8orbits_4[:, 5] -= 30
# constellation_8orbits_5[:, 5] -= 60
