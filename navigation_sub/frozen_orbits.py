...
class FrozenOrbits:
    ...
    def __init__(self):
        ...
        self.orbit_choices = [[8025.9e3, 0.004, 39.53, 270, 5, 4, 0, 0], [8148.8e3, 0.004, 39.51, 90, 5, 4, 0, 0],
                              [7298.6e3, 0.001, 39.71, 270, 3, 7, 0, 1], [8669.2e3, 0.024, 39.46, 270, 4, 6, 0, 0],
                              [8916.6e3, 0.000, 39.41, 90, 4, 6, 0, 1], [8904.4e3, 0.00, 39.41, 90, 4, 6, 0, 1], [7434.8e3, 0.00, 39.67, 270, 3, 7, 1, 1],
                              [7298.6e3, 0.001, 39.71, 90, 3, 7, 0, 1], [8954.2e3, 0.002, 39.40, 90, 4, 6, 0, 1],
                              [8536.0e3, 0.025, 39.47, 270, 4, 6, 0, 0], [5701.2e3, 0.002, 40.78, 90, 4, 6, 0, 1],
                              [8855.4e3, 0.023, 39.43, 270, 4, 6, 0, 0], [8904.4e3, 0, 39.41, 90, 4, 6, 0, 1]]
