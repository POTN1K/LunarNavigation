...
class Tower:
    ...
    def __init__(self, phi=0, theta=0, height=0, elevation=15):
...
class Lagrange:
    def __init__(self, l_point, elevation=15):
...
class FixPoint:
    def __init__(self, r, elevation=15):
...
class Model:
    ...
    def addFixPoint(self, r, elevation=15):
